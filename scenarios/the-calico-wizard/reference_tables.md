...
|     2      | **black** | Bats                   |              |    -    | -(F / 3) HP   | A flurry of bats escape and attack you and anyone **on or adjacent to your spot**. All characters in range take damage and **cannot defend**. |
...
|     8      |  red      | Sharp Arrows (x10)     |              |   0.1   | +2 dmg        | Ouch! That's a sharp tip. Must be used with a bow. All arrows are single use. |
...
|     13     | _mixed_   | Chest Key ~            |             |   0.1   |                | Use to [open a locked chest](../../rules/07_chests_and_items.md). This is automatic and consumes your turn. |
